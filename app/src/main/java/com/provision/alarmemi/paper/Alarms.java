...
public class Alarms {
	...
	public static final String ALARM_ALERT_ACTION = "com.provision.alarmemi.ALARM_ALERT";
	...
	public static final String ALARM_DONE_ACTION = "com.provision.alarmemi.ALARM_DONE";
	...
	// ALARM_DONE_ACTION).
	public static final String ALARM_SNOOZE_ACTION = "com.provision.alarmemi.ALARM_SNOOZE";

	// AlarmAlertFullScreen listens for this broadcast intent, so that other
	// applications
	// can dismiss the alarm (after ALARM_ALERT_ACTION and before
	// ALARM_DONE_ACTION).
	public static final String ALARM_DISMISS_ACTION = "com.provision.alarmemi.ALARM_DISMISS";
	...
	// This string is used to identify the alarm id passed to SetAlarmFragment from the
	// list of alarms.
	...
	public static ContentValues createContentValues(Alarm alarm) {
		...
		values.put(Alarm.Columns.CLOUD_ENABLED, alarm.cloudEnabled ? 1 : 0);
		values.put(Alarm.Columns.CLOUD_NAME, alarm.cloudName);
		values.put(Alarm.Columns.CLOUD_DEVICES, alarm.cloudDevices);
		values.put(Alarm.Columns.CLOUD_KEY, alarm.cloudKey);
		values.put(Alarm.Columns.CLOUD_UID, alarm.cloudUID);
		values.put(Alarm.Columns.MEMI_COUNT, alarm.memiCount);
		values.put(Alarm.Columns.SNOOZE_STRENGTH, alarm.snoozeStrength);
		values.put(Alarm.Columns.SNOOZE_COUNT, alarm.snoozeCount);
		values.put(Alarm.Columns.COLOR, alarm.color);
