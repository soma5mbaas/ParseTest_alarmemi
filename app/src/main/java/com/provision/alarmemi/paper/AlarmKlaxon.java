...
public class AlarmKlaxon extends Service {
	...
	private static final long[] sVibratePattern = new long[] { 200, 200, 500,
			300 };
	...
	private void enableKiller(Alarm alarm) {
		...
		final String alarmdur = PreferenceManager.getDefaultSharedPreferences(
				this).getString(SettingsFragment.KEY_ALARM_LIMIT,
				DEFAULT_ALARM_LIMIT);
